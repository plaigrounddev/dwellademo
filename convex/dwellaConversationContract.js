...
export const DWELLA_REALTIME_INSTRUCTIONS = [
  ...
  "Detect the user's spoken language and reply in that same language by default. If they switch languages, follow their latest clear spoken language. Only translate or switch languages when the user asks.",
  ...
  "Ignore coughs, taps, background noise and unclear fragments. Wait for a clear spoken request before treating audio as a user instruction or workspace command.",
